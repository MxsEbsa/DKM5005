...
function verificar_reinicio(){
  ...
  if(window.sessionStorage.getItem('reiniciar_oed')=='sim'){
	...
	if(window.sessionStorage.getItem('reiniciar_oed')=='instrucoes_sim'){
		document.querySelector(".btn_instrucoes").style.width="92px";
	}
	if(window.sessionStorage.getItem('reiniciar_oed')=='instrucoes_nao'){
		document.querySelector(".btn_instrucoes").style.width="0px";
	}	
	}, 1000);
}